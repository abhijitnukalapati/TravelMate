...
import com.gill.travelmate.fragments.RestaurantsFragment;
...
//Adapter to add items into filter list of Restaurant
public class RestaurantFilterAdapter extends RecyclerView.Adapter<RestaurantFilterAdapter.ChatHolder>{
    ...
    public RestaurantFilterAdapter(Context mContext, ArrayList<String> cat_arr, ArrayList<String> values_arr, ArrayList<Integer> images, RestaurantsFragment restaurantsFragment) {
    ...
    public void onBindViewHolder(ChatHolder holder, int position) {
        ...
        if(tinyDB.getString(GeneralValues.RESTAURANT_FILTER).equalsIgnoreCase(values_list.get(position))){
