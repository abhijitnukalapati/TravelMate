...
//Adapter to add hotels list into HotelFragment
public class HotelsAdapter extends RecyclerView.Adapter<HotelsAdapter.ChatHolder>{

    private Context mContext;
    private ArrayList<HotelsArraylist> list;
    Intent i;

    public HotelsAdapter(Context mContext, ArrayList<HotelsArraylist> list) {
    ...
    public ChatHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("check", GeneralValues.HOTEL_CHECK);
