...
//Adapter to add list of NearPlacesFragment
public class NearPlacesAdapter extends RecyclerView.Adapter<NearPlacesAdapter.ChatHolder>{

    private Context mContext;
    private ArrayList<PlacesNearArraylist> list;
    Intent i;

    public NearPlacesAdapter(Context mContext, ArrayList<PlacesNearArraylist> list) {
    ...
    public ChatHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("check", GeneralValues.PLACES_CHECK);
