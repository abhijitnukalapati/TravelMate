...
//Adapter to add data into list of RestaurantFragment
public class RestaurantAdapter extends RecyclerView.Adapter<RestaurantAdapter.ChatHolder>{

    private Context mContext;
    private ArrayList<RestaurantsArraylist> list;
    Intent i;

    public RestaurantAdapter(Context mContext, ArrayList<RestaurantsArraylist> list) {
    ...
    public ChatHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("check", GeneralValues.RESTAURANT_CHECK);
